...
public class AdLoopViewPager extends ViewPager {
    ...
    public AdvertPageAdapter getAdapter() {
        return mAdapter;
    }
    ...
    public AdLoopViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
