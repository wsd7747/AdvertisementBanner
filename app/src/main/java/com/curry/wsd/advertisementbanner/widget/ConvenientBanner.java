package com.curry.wsd.advertisementbanner.widget;
...
import com.curry.wsd.advertisementbanner.adapter.AdvertPageAdapter;
import com.curry.wsd.advertisementbanner.holder.AdViewHolderCreator;
import com.curry.wsd.advertisementbanner.listener.AdPageChangeListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private AdvertPageAdapter pageAdapter;
    ...
    private void init(Context context) {
        ...
        viewPager = (AdLoopViewPager) hView.findViewById(R.id.adLoopViewPager);
    ...
    public ConvenientBanner setPages(AdViewHolderCreator holderCreator, List<T> datas){
        this.mDatas = datas;
        pageAdapter = new AdvertPageAdapter(holderCreator,mDatas);
    ...
    public AdLoopViewPager getViewPager() {
        return viewPager;
    }
